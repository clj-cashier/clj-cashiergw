package com.apricot.clj.cashiergw.web;
...
@ControllerAdvice
@ComponentScans({@ComponentScan("com.apricot.clj.cashiergw"),@ComponentScan("com.apricot.framework.web")})
@DubboComponentScan(basePackages = {"com.apricot.framework.extend.dubbo.filter", "com.apricot.clj.cashiergw.service.client.impl"})
@Slf4j
